...
const destinations = [`Moscow`, `Saratov`, `Kazan`, `Zelenograd`];

const additionalOptions = {
  action: [`add luggage`, `switch to comfort class`],
  place: [`add meal`, `choose seats`, `travel by train`]
};
...
const types = {
  action: [`taxi`, `bus`, `train`, `ship`, `transport`, `drive`, `flight`],
  place: [`check-in`, `sightseeing`, `restaurant`]
};
...
const generatePoint = () => {
  ...
  point.groupType = generateGroupType();
  point.type = generateType(point.groupType);
