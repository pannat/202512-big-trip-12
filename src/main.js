...
const getTripInfo = () => `<section class="trip-main__trip-info trip-info"></section>`.trim();

const getRoute = () => `<div class="trip-info__main">
              <h1 class="trip-info__title">Amsterdam &mdash; Chamonix &mdash; Geneva</h1>
              <p class="trip-info__dates">Mar 18&nbsp;&mdash;&nbsp;20</p>
            </div>`.trim();

const getTotalCost = () => `<p class="trip-info__cost">
              Total: &euro;&nbsp;<span class="trip-info__cost-value">1230</span>
            </p>`.trim();

const getNav = () => `<nav class="trip-controls__trip-tabs  trip-tabs">
              <a class="trip-tabs__btn  trip-tabs__btn--active" href="#">Table</a>
              <a class="trip-tabs__btn" href="#">Stats</a>
            </nav>`.trim();

const getFilters = () => `<form class="trip-filters" action="#" method="get">
...
const getSorting = () => `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
...
const getDayList = () => `<ul class="trip-days"></ul>`.trim();

const getDay = () => `<li class="trip-days__item day">
                        <div class="day__info">
...
const getPointEdit = () => `<form class="trip-events__item  event  event--edit" action="#" method="post">
...
const getPoint = () => `<li class="trip-events__item">
                  <div class="event">
